...
render() {  
  ...
  if(this.state.focus){
    labelFl = {position: 'absolute',color:`var(--color-form--)`, transform: `translate3d(-5px, -15px, 0)`,transformOrigin: '93.5px center 0px',fontSize:'12px'}
    BoxB = { border: `2px solid var(--color-form--)`,padding: `15px 12px`}
  }
  if(!this.state.valid){
    labelFl = {position: 'absolute',color:`#b71c1c`, transform: `translate3d(-5px, -15px, 0)`,transformOrigin: '93.5px center 0px',fontSize:'12px'}
    BoxB = { border: `2px solid #b71c1c`,padding: `15px 12px`}
  }
  ...
  return(   
    <div className="Wxwduf" style={BoxB} onClick={this.handleClickFocus}>
